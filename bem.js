...
module.exports = function BEM(args, items){
	...
	let opts = {
		...
		element: selector.match(/(?:__)([a-zA-Z0-9]*-?[a-zA-Z0-9]*)/), //  (?:__)([a-zA-Z0-9]*-?[a-zA-Z0-9]*)(?<!-) - не работает в node поэтому отрезаем последнее подчеривание дополнительным match(/.*[a-zA-Z0-9]/)
